...
//   return (
//     <div className="flex justify-center items-center min-h-screen bg-[whitesmoke] text-white">
//       <div className="w-full max-w-md p-6 bg-[#FEF9F8] rounded-lg  shadow-2xl">
//       <img src={Logo} alt="Logo" className="h-8" />
//       <span className='text-black'>GlobalSpeak</span>
...
//                 required
//                 className="mt-1 block w-full bg-transparent p-2 text-black placeholder-gray-400 focus:outline-none"
//               />
...
//               placeholder="500"
//               required
//               className="mt-1 block w-full border border-[#BEBEBE] rounded-md bg-white p-2 text-black placeholder-gray-400 focus:outline-none"
//             />
//           </div>
...
//               required
//               className="mt-1 block w-full border border-[#BEBEBE] rounded-md bg-white p-2 text-white placeholder-gray-400 focus:outline-none"
//             />
//           </div>
...
//         <img src={orangeLogo} alt="Orange Money Logo" className="w-24 mx-auto mt-4" />
//       </div>
//     </div>
//   );
// };
...
export const PaymentInterface = () => {
  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-[whitesmoke]">
      <div className="flex w-full max-w-3xl p-8 bg-[#FEF9F8] rounded-lg shadow-2xl">
