        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="p-6">
            <div className="flex items-center gap-2 mb-4">
              <MdVideoLibrary className={`text-xl ${darkMode ? 'text-gray-300' : 'text-gray-700'}`} />
            ...
            >
              ...
              {videoFile ? (
                <div className="text-center">
                  <p className={`font-medium truncate max-w-full ${darkMode ? 'text-white' : 'text-gray-800'}`}>
                    {videoFile.name}
                  </p>
            ...
            <div className={`mt-4 p-4 rounded-lg ${darkMode ? 'bg-gray-700' : 'bg-[#FEF9F8]'}`}>
              <h4 className={`font-medium mb-2 ${darkMode ? 'text-white' : 'text-gray-800'}`}>Video Guidelines:</h4>
